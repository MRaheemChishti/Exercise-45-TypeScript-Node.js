...
// Assignment 11 (Names)
console.log("\nAssignment 11 (Names)");
let members = [`Ahad`, `Hamza`, `Arbaz`, `Armaghan`];
...
console.log("\nAssignment 14 (Guest List)");
let Guest_List = [`Arbaz`, `Daniyal`, `Hamza`, `Armghan`, `Ahad`];
...
console.log("\nAssignment 18 (Seeing The World)");
let Places = [`Istanbul`, `Dubai`, `Karbala`, `Bursa`, `Ankara`];
...
console.log("\nAssignment 20 (Think Of Something You Could Store In A Array)");
let Cities = ['Karachi', 'Lahore', 'Islamabad', 'Multan', 'Faislabad', 'Hyderabad'];
...
console.log("\nAssignment 22 (Intentional Error)");
let arry = ['Ahad', 'Arbaz', 3, 5, 6, "Ramsha"];
console.log(arry[5]);
console.log(arry[0]);
console.log(arry[3]);
console.log(arry[1]);
...
let name1 = "Muhammad Raheem Chishti";
let name2 = "M Raheem Chisti";
let name3 = "mr. raheem chishti";
let age1 = 23;
let num_1 = 20;
let Country = ["Pakistan", "India", "Turkey", "China", "Dubai"];
//Test 1: Equality
...
let favorite_fruits = ['Apple', 'Mango', 'Bananas'];
...
let users = ['Raheem', 'Arbaz', 'Ahad', 'Ramsha', 'Admin'];
...
console.log("\nAssignment 32 (Checking Username)");
let current_users = ["Ahad", "Arbaz", "Ramsha", "Raheem", "Admin"];
let new_users = ["Armaghan", "Arbaz", "Daniyal", "Ahad", "Wasey"];
...
const Magician = ["Ubaid", "Shakoor", "Muqdas"];
...
const Magician2 = ["Ubaid", "Shakoor", "Muqdas"];
...
const Magician3 = ["Ubaid", "Shakoor", "Muqdas"];
